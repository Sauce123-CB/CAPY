...
# ==========================================================================================
# CVR KERNEL (G3_2.2.3e Implementation - MRC Paradigm / Atomized Prompts)
# ==========================================================================================
...
def calculate_apv(forecast_df, dr, kg):
    ...
    # 3. Determine Terminal Growth (g) and ROIC Anchor (r)
    ...
    # Use ROIC_anchor from epistemic anchors if available, else default
