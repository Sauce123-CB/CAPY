# G3ENRICH 2.2.2e: Bayesian Causal Synthesis

> **Version:** 2.2.2e (Atomized)
> **Change from 2.2.1e:** Split into 4 files for improved context management. Updated for 7-slot RQ architecture (M-3a/M-3b).

## I. MISSION AND OBJECTIVES

* Mission: Execute the ENRICHMENT stage (G3_2.2.2e) of the CAPY Pipeline for {Company Name} ({EXCHANGE:TICKER}) as of {DATE}.
...
- G3ENRICH_2.2.2e_PROMPT.md (this file)
- G3ENRICH_2.2.2e_SCHEMAS.md
- G3ENRICH_2.2.2e_NORMDEFS.md
- MRC State 1 Output ({TICKER}_BASE2.2.2eO_T2_{YYYYMMDD}.md)
- A.8_RESEARCH_STRATEGY_MAP (from RQ output)
- RQ Outputs (1-7)
- CVR_KERNEL_ENRICH_2.2.2e.py (reference context only)

Scope: Execute Phases A-D. Produce unified narratives (N1-N5) and artifacts A.1-A.6, A.9. Artifact A.7 is NOT computed.

Output: Unified emission per Section V. Filename: {TICKER}_ENRICH2.2.2eO_T1_{YYYYMMDD}.md
...
- G3ENRICH_2.2.2e_SCHEMAS.md
- G3ENRICH_2.2.2e_NORMDEFS.md
- Turn 1 Output ({TICKER}_ENRICH2.2.2eO_T1_{YYYYMMDD}.md)
- CVR_KERNEL_ENRICH_2.2.2e.py
...
Output: Complete MRC State 2. Filename: {TICKER}_ENRICH2.2.2eO_T2_{YYYYMMDD}.md
...
(Emit the JSON object containing the 7 artifacts here, strictly adhering to G3ENRICH_2.2.2e_SCHEMAS.md.)
