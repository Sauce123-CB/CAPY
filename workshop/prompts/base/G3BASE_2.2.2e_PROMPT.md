# G3BASE 2.2.2e: Autonomous Causal Valuation

> **Version:** 2.2.2e (Atomized)
> **Change from 2.2.1e:** Split into 3 files for improved context management. Appendix C (embedded kernel) removed.

# I. MISSION AND OBJECTIVES

-   **Mission:** Execute the BASE stage (G3_2.2.2e) of the CAPY Pipeline
...
- **Attachments Required:**
  - This prompt (G3BASE_2.2.2e_PROMPT.md)
  - G3BASE_2.2.2e_SCHEMAS.md (Appendix A)
  - G3BASE_2.2.2e_NORMDEFS.md (Appendix B)
  - Company Documents (filings, transcripts, supplementary materials)
  - BASE_CVR_KERNEL_2.2.2e.py (reference context only)
...
- **Output:** Unified emission per Section V. Filename: `{TICKER}_BASE2.2.2eO_T1_{YYYYMMDD}.md`
...
- **Attachments Required:**
  - This prompt (G3BASE_2.2.2e_PROMPT.md)
  - G3BASE_2.2.2e_SCHEMAS.md
  - G3BASE_2.2.2e_NORMDEFS.md
  - Turn 1 Output ({TICKER}_BASE2.2.2eO_T1_{YYYYMMDD}.md)
  - BASE_CVR_KERNEL_2.2.2e.py
...
- **Output:** Complete MRC State 1 with executed A.7. Filename: `{TICKER}_BASE2.2.2eO_T2_{YYYYMMDD}.md`
