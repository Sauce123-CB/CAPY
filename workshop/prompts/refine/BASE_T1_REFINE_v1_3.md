...
> **Patch v1.3:** Equity Bridge preservation check (FDSO, Total_Debt, Excess_Cash, Minority_Interest)
...
Equity Bridge: FDSO=[X], Total_Debt=[X], Excess_Cash=[X], Minority_Interest=[X] → Preserved from T1 [YES/NO]
